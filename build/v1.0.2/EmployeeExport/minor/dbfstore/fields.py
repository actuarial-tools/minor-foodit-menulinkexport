...
class DbfCharacterField(DbfField):
    ...
    def decode(self, value, encoding=locale.getpreferredencoding()):
        ...
        """
        return value.decode(encoding,errors='ignore').rstrip(" ")
...
class DbfDateField(DbfField):
    ...
    def decode(self, value, encoding=locale.getpreferredencoding()):
        ...
        if value.strip():
            return utils.get_date(value.decode(encoding,errors="ignore"))
        else:
            return None
    ...
    def encode(self, value, encoding=locale.getpreferredencoding()):
        ...
        """
        if value:
            return utils.get_date(value).strftime("%Y%m%d").encode(encoding,errors="ignore")
        else:
